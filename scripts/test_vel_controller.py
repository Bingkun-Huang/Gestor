...
from gripper import move_gripper, grasp_gripper
...
def main():
    ...
    def send_commands():
        ...
        rospy.sleep(1.0) 
        grasp_result = grasp_gripper()
        print("[Grasp] Success: ", grasp_result.success)
